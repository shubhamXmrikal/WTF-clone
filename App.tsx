...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    if (currentPage === 'bookings') {
      return <MyBookings userId={user?._id || ''} />;
    }
    ...
    if (currentPage === 'events') {
      return <EventsPage onBookEvent={handleBookClick} />;
    }
        ...
        <header className="relative pt-4 md:pt-8 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-12 pb-16 md:pb-32 flex flex-col md:flex-row items-center gap-8 md:gap-0">
            ...
            <div className="md:w-1/2 mt-8 md:mt-0 relative">
              ...
              <img src={phoneImages} alt="App Screen" className="w-full h-auto max-w-md mx-auto md:max-w-full object-contain opacity-80" />
            </div>
          </div>
        </header>
